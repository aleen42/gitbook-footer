    	...
    	'page:before': function (page) {
            ...
            const htmlContents = ' \n\n<footer class="page-footer">' + 
                ...
                '<span class="description" style="color: ' + defaultOption.timeColor + ' !important;">' +
                    '<span class="time-description" style="color: #999;">' + defaultOption.description + '</span>' +
                    '\n{{file.mtime | date("' + defaultOption.format + '", ' + defaultOption.utcOffset + ')}}\n' +
                '</span>' + 
            '</footer>';
