...
const pageFooter = module.exports = {
    ...
    hooks: {
    	'page:before': function (page) {
            ...
            const styleName = 'symmetrial';

            const htmlContents = ' \n\n<footer class="footer">' + 
                '<div class="footer__container--' + styleName + '" alt="' + uri + '">' +
                    qrImg +
                    '<div class="footer__description--' + styleName + '">' +
                        '<p class="paragraph footer__author--' + styleName + '" style="color: #000 !important;">' + defaultOption.author + '<sup class="super">&#174;</sup></p>' +
                        '<p class="paragraph footer__quote--' + styleName + '" style="color: #000 !important;">' + defaultOption.wisdom + '</p>' +
                        '<div class="footer__main--' + styleName + '">' +
                            '<p class="paragraph footer__main__paragraph--' + styleName + ' copyright" style="color: ' + defaultOption.copyrightColor + ' !important;">' + defaultOption.copyright +  '</span>' +
                            '<p class="paragraph footer__main__paragraph--' + styleName + ' footer__modifyTime--' + styleName + '" style="color: ' + defaultOption.timeColor + ' !important;">' +
